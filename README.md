...
2. Если для клиента удалось найти слот с вебинаром, запускается отдельный бизнес-процесс, который в конструкции имеет вызов Webhook. Всего для отправки из бизнес-процесса предусмотрено 14 уведомлений клиенту с разным интервалом. Интервалы отправки настроены бизнес-процессом. 
